 ...
 */
class DatesFutureTest extends BrowserTestBase {
   ...
   */
  public function testFutureEventNotArchived() {

    // @todo remove hardcoded date.
    $event_date = [
      'value' => '2025-08-01T16:00:00',
      'end_value' => '2025-08-01T18:00:00',
      'rrule' => '',
    ...
    // @todo remove hardcoded date.
    $this->assertEquals("2025-08-01T18:00:00", $event->get('localgov_event_date')->end_value, 'Event end date is not correct.');
    ...
    $this->assertTrue($refreshed_event->isPublished(), 'The event status is should remain published.');
    // Check that the status is set to archived.
    $this->assertEquals("1", $refreshed_event->get('status')->value, 'Event status should be published');
